...
- The editor and the document share a style sheet
  - To avoid messing up the editor's CSS, add the \`.wmde-markdown\` class in front of all styles to keep them from propogating, as I have done below
